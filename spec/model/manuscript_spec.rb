...
require File.expand_path(File.dirname(__FILE__)) + "/../../service/model/manuscript.rb"

describe Model::Manuscript, "#to_json" do
  
  it "should provide json representation of the manuscript" do
    manuscript = Model::Manuscript.new(1, "http://dmstech.stanford.edu/manuscript/1")
